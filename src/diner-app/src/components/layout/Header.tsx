    ...
    <header className="flex justify-between items-center px-8 py-4 border-b border-border bg-[#0C0A09ee] glass sticky top-0 z-50">
      <div className="flex items-center gap-3 cursor-pointer" onClick={() => navigate('/')}>
        <div className="flex flex-col leading-none">
          <span className="font-sans text-[9px] font-semibold text-accent uppercase tracking-[4px] mb-0.5">
            Anna's
          </span>
          <span className="font-serif text-[22px] font-black text-text-primary tracking-tight relative">
            Book<span className="text-accent">table</span>
            <span className="absolute bottom-[-2px] left-0 right-0 h-px bg-gradient-to-r from-accent to-transparent" />
          </span>
        </div>
      </div>
